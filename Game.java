...
public class Game {
    ...
    public void Draw(Graphics2D g2d, Point mousePosition)
    {
        ...
        g2d.drawString("ENFUIS: " + runawayDucks, 10, 21);
        g2d.drawString("MORTS: " + killedDucks, 160, 21);
        g2d.drawString("TIRS: " + shoots, 299, 21);
    ...
    public void DrawGameOver(Graphics2D g2d, Point mousePosition)
    {
        ...
        g2d.drawString("Appuyez sur ESPACE ou ESC pour rejouer.", Framework.frameWidth / 2 - 149, (int)(Framework.frameHeight * 0.70) + 1);
        g2d.setColor(Color.red);
        g2d.drawString("Game Over", Framework.frameWidth / 2 - 40, (int)(Framework.frameHeight * 0.65));
        g2d.drawString("Appuyez sur ESPACE ou ESC pour rejouer.", Framework.frameWidth / 2 - 150, (int)(Framework.frameHeight * 0.70));
    }
}
